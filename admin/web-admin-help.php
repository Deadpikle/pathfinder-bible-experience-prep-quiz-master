...
<div id="admin-help">
    <div class="row">
        <div class="col s12 m8">
            ...
            <p>The PBE quiz engine website is set up such that each year of PBE questions can be hosted on the same website without doing a large amount of work to transition in between years. Each year can use different Bible books, commentary volumes, study guides, and quiz questions. Users, conferences, and administrator users remain the same.</p>
            <p></p>
        </div>
    </div>
</div>
