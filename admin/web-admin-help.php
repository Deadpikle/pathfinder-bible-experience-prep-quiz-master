    ...
    <div class="row">
        ...
        <h5>Adding new Website Administrators</h5>
            ...
            <p>To transition from the current PBE year to the upcoming year, perform the following operations:
                <ol>
                    <li>Change the website's current year to the upcoming PBE year on the <a href="view-years.php">Years page</a></li>
                    <li>Go to the <a href="view-books.php">Bible books page</a> and add in the Bible books that will be used for the PBE year. These are the Bible books that will be available when creating new questions. Make sure to set the number of chapters to the correct number!</li>
                    <li>For each book that you added on the Bible books page, click 'Manage Chapters'. Add chapters for that book of the Bible for each chapter that will be quizzed over (e.g. one for Daniel 1, one for Daniel 2). Make sure to set the number of verses for that chapter to the correct number!</li>
                    <li>At this point, Bible books are ready to go. Now go to the <a href="view-commentaries.php">commentaries page</a> and add the commentary volumes that will be used for the new PBE year. Make sure to type in the correct volume number and topic. The system does not check to make sure that the given topic exists in the volume number that you type in.</li>
                    <li>Now that all the books and commentaries are set up, double check the available <a href="view-conferences.php">conferences</a> that can access the system as well as each conference's contact information. The conferences set up on this page are the ones that show up on the About page, and they're also the ones that show up when adding new users to the system.</li>
                    <li>When your study guides for the new year are ready, upload them on the <a href="view-study-guides.php">study guides</a> page.</li>
                    <li>Let your users know everything is ready for the new year, and enjoy another year of PBE learning!</li>
                </ol>
            </p>
        </div>
    </div>
