...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?=$basePath?>/lib/materialize/css/materialize.min.css?v=20170806" media="screen,projection"/>
        <!--Let browser know website is optimized for mobile-->
        <meta name="viewport" content="width=device-width, initial-scale=1.0"/>

        <link rel="stylesheet" href="<?=$basePath?>/css/common.css?v=20170806" />
        ...
        <script src="<?=$basePath?>/js/common.js?v=20170806"></script>
    </head>
    <body>
        <header>
            <nav>
